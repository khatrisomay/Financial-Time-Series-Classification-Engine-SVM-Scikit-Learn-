...
1. **Python Machine Learning Engine (`backend/`)**:
   ...
   - **FastAPI REST Server**: Serves live predictions, kernel comparisons, hyperparameter optimization, CSV report exports, and Monte Carlo forecasts.
